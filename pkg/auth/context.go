...
// WithIdentity stashes the resolved portal-session identity for downstream
// handlers (e.g. /portal/api/whoami).
...
// auth state, none of which the portal needs to introspect and all of which
// are dangerous to surface in a UI.
...
// WithHeaders stashes a redacted clone of the inbound HTTP headers.
