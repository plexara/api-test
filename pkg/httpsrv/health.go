// Package httpsrv composes the HTTP mux that mounts api-test's endpoint
// groups, health probes, and (later milestones) the portal SPA, admin API,
...
// Readiness tracks the server's "ready to accept new traffic" flag. Flipped
// to false during shutdown so load balancers can drain.
